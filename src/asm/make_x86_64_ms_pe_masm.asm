...
; .file "make_x86_64_ms_pe_masm.asm"
...
sew_make_context PROC FRAME
    
    ; .xdata for a function's structured exception handling unwind behaviour
    .endprolog

    ; first arg of sew_make_context() == top of context-stack
    mov     rax,    rcx

    ; reserve 32 byte shadow-space for context-function
    sub     rax,    028h

    ; shift address in RAX to lower 16 byte boundary
    ; == pointer to sew_context_t and address of context-stack
    and     rax,    -16
...
finish:
    ; 32 byte shadow-space for _exit() are 
    ; already reserved by sew_make_context()
    ; exit code is zero
    xor     rcx,    rcx
